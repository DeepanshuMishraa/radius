  ...
  const rpc: any = BrowserView.defineRPC<RadiusRPC>({
    ...
    handlers: {
      requests: {
        ...
        getComposeSession: handleGetComposeSession,
        getSyncHistory: handleGetSyncHistory,
        ...
        markMessageUnread: handleMarkMessageUnread,
        toggleMessageImportant: handleToggleMessageImportant,
